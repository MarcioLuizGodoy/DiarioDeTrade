...
AQUI SEGUEM INFORMAÇÕES PARA INSTALAÇÃO DE QUALQUER VERSAO DO APP QUE ESTEJA NO DIRETORIO DISTRIBUIÇÃO. 


&nbsp;                               AQUI FICAM AS INFORMAÇÕES NECESSÁRIAS PARA VOCÊ TESTAR ESTA DISTRIBUIÇÃO DE TESTE!
...
2 - EXECUTAR O SCRIPT dbCode.sql NO TERMINAL DO MYSQLl ( MySQL 8.4 Command Line Cli ). 
